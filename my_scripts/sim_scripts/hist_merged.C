...
void hist_merged(){
	...
	TFile* file = new TFile("/home/users/ymehra/CMSSW_10_6_26/src/tttt/test/output/data_run1/2017D/DoubleEG_2017D.root","read");
	TFile* output = new TFile("/home/users/ymehra/CMSSW_10_6_26/src/tttt/test/output/data_run1/2017D/output.root","recreate");
	...
	TH2F* fraction_flips = new TH2F("flip_rate","flip_rate",nbins_pt, pt_bins, nbins_eta, eta_bins);
